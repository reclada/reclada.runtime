...
python3 -m badgerdoc.table_extractor.run run ${_INPUT_DIR}/input.pdf ${_OUTPUT_DIR} --verbose true --paddle_on true

python3 -m bd2reclada ${_OUTPUT_DIR}/document.json ${_OUTPUT_DIR}/output.csv
