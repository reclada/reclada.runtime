...
aws s3 rm "s3://${AWS_S3_BUCKET_NAME}/output/${_JOB_ID}/context/output/" --recursive --sse > /dev/null
aws s3 rm "s3://${AWS_S3_BUCKET_NAME}/output/${_JOB_ID}/context/input/" --recursive --sse > /dev/null
